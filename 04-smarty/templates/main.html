...
<head>
    ...
    <link rel="stylesheet" href="{$app_url} /vendor/bootstrap/bootstrap.min.css">
    <link rel="stylesheet" href="{$app_url} /vendor/select2/select2.min.css">
    <link rel="stylesheet" href="{$app_url} /vendor/owlcarousel/owl.carousel.min.css">
    <link rel="stylesheet" href="{$app_url} /vendor/lightcase/lightcase.css">
    <link rel="stylesheet" href="/css/pure/pure-min.css">
    <link rel="stylesheet" href="/css/pure/grids-responsive-min.css">
    <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">
	<link rel="stylesheet" href="{$app_url}/css/szablon.css">
